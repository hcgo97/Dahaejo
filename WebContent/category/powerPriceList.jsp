...
if (request.getParameter("priceList") == null || request.getParameter("priceList").equals("")) {
	...
	powerPrice = request.getParameter("priceList");
}
...
String sqlTot = "select count(*) total from power"
			+	"	where price " + powerPrice;
...
<body class="homepage is-preload">
   ...
   String searchSQL =	" select b.*from ( "
   					...
   					+	"		(select name,link,company,price from power b "
   					+	"	where price " + powerPrice
   					+	"		order by price ) a ) b "
   ...
   %>
	...
	<form class="form" name = "frm" method = "post" action = "powerPriceList.jsp" style="width:1000px">
	가격대 선택<br>
   ...
   <table border="0" width="600" align="center">
	   <tr>
	      ...
	      <%
	      String link = "powerPriceList.jsp?priceList=" + powerPrice;
