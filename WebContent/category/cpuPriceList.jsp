...
if (request.getParameter("priceList") == null || request.getParameter("priceList").equals("")) {
	...
	cpuPrice = request.getParameter("priceList");
}
...
String sqlTot = "select count(*) total from cpu"
			+	"	where price " + cpuPrice;
...
<body class="homepage is-preload">
   ...
   String searchSQL =	" select b.*from ( "
   					...
   					+	"		(select name,link,company,price from cpu b "
   					+	"	where price " + cpuPrice
   					+	"		order by price ) a ) b "
   ...
   %>
	...
	<form class="form" name = "frm" method = "post" action = "cpuPriceList.jsp" style="width:1000px" >
	가격대 선택<br>
   ...
   <table border="0" width="600" align="center">
	   <tr>
	      ...
	      <%
	      String link = "cpuPriceList.jsp?priceList=" + cpuPrice;
