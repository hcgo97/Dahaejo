...
if (request.getParameter("priceList") == null || request.getParameter("priceList").equals("")) {
	...
	memoryPrice = request.getParameter("priceList");
}
...
String sqlTot = "select count(*) total from memory"
			+	"	where price " + memoryPrice;
...
<body class="homepage is-preload">
   ...
   String searchSQL =	" select b.*from ( "
   					...
   					+	"		(select name,link,company,price from memory b "
   					+	"	where price " + memoryPrice
   					+	"		order by price ) a ) b "
   ...
   %>
	...
	<form class="form" name = "frm" method = "post" action = "memoryPriceList.jsp" style="width:1000px">
	가격대 선택<br>
   ...
   <table border="0" width="600" align="center">
	   <tr>
	      ...
	      <%
	      String link = "memoryPriceList.jsp?priceList=" + memoryPrice;
