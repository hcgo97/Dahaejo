...
if (request.getParameter("priceList") == null || request.getParameter("priceList").equals("")) {
	...
	gpuPrice = request.getParameter("priceList");
}
...
String sqlTot = "select count(*) total from gpu"
			+	"	where price " + gpuPrice;
...
<body class="homepage is-preload">
   ...
   String searchSQL =	" select b.*from ( "
   					...
   					+	"		(select name,link,company,price from gpu b "
   					+	"	where price " + gpuPrice
   					+	"		order by price ) a ) b "
   ...
   %>
	...
	<form class="form" name = "frm" method = "post" action = "gpuPriceList.jsp" style="width:1000px">
	가격대 선택<br>
   ...
   <table border="0" width="600" align="center">
	   <tr>
	      ...
	      <%
	      String link = "gpuPriceList.jsp?priceList=" + gpuPrice;
