...
if (request.getParameter("priceList") == null || request.getParameter("priceList").equals("")) {
	...
	ssdhddPrice = request.getParameter("priceList");
}
...
String sqlTot = "select count(*) total from ssdhdd"
			+	"	where price " + ssdhddPrice;
...
<body class="homepage is-preload">
   ...
   String searchSQL =	" select b.*from ( "
   					...
   					+	"		(select name,link,company,price from ssdhdd b "
   					+	"	where price " + ssdhddPrice
   					+	"		order by price ) a ) b "
   ...
   %>
	...
	<form class="form" name = "frm" method = "post" action = "ssdhddPriceList.jsp" style="width:1000px">
	가격대 선택<br>
   ...
   <table border="0" width="600" align="center">
	   <tr>
	      ...
	      <%
	      String link = "ssdhddPriceList.jsp?priceList=" + ssdhddPrice;
