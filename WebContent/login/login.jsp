...
<form name= "frm" method="post" action="loginProc.jsp">		
	...
	<table border="0" style=margin-left:300px>
			<tr>
				<td><label for="userid" style="height:50px; font-size:30px;">아이디</label></td>
				<td><input type="text" name="userid" id="userid" style="width:300px;height:30px;font-size:30px;" placeholder="아이디입력">
				</td>
			</tr>
			<tr>
				<th><label for="pass" style="height:50px; font-size:30px;">비밀번호</label></th>
				<td><input type="password" name="pass" id="pass" style="width:300px;height:30px;font-size:30px;" placeholder="비밀번호입력"></td>
			</tr>
		<table boder="0">
			<tr>
				<th colspan="2">
