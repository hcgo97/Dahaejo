...
<%
String sqlTot = "select count(*) total from adminboard";
...
String sql = "  select b.* from  ( "
		   ...
		   + "				(select count(*) from admin_reply where board_unq = b.unq) as total "
		   + "			from adminboard b"
...
<table border="0" width="1000" align="center">
	<tr>
		<td align="right">
			<button type="button" style="cursor:pointer" onclick="location='adminWrite.jsp'">글쓰기</button>
		</td>
	</tr>
</table>
...
<table border="1" width="1000" align="center" style="border-collapse:collapse; border: 1px solid black;">
	...
	%>
		<tr>
			...
			<a href="adminDetail.jsp?unq=<%=unq %>&name=<%=name %>"><%=title %>
...
<table border="0" width="600" align="center">
	<tr>
		...
		%>
			  <a href="adminList.jsp?page=<%=i %>"><%=i %></a> 
		<%
		}
		%>
